...
Third, we empirically validate this tradeoff across seven unlearning methods, revealing a Pareto frontier between erasure strength and utility preservation (\Cref{sec:experiment}).
